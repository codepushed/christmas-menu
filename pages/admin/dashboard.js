...
const Admin = () => {
  ...
  // Authentication is handled by AuthGuard component
  useEffect(() => {
    setIsAuthenticated(true); // We're already authenticated if we're here
  }, []);
  ...
  return (
    <div className={styles.container}>
      <Head>
      <title>Admin | By Kwiktable</title>
          <meta name="description" content="Kwiktable provide one tap menu creation and ordering experience" />
          <meta name="keywords" content="Menus, Kwiktable, Menu Management, Ordering, Restaurant, Food" />
          <meta name="author" content="Kwiktable" />
          <meta name="viewport" content="width=device-width, initial-scale=1" />
...
// Wrap the component with AuthGuard for authentication protection
